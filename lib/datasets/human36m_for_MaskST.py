...
class Human36MMultiViewDataset(Dataset):
    ...
    def __init__(
            ...
            depths_label="/data0/wxy/stereo_matching/aanet/res/z_pred.npy",
            depthmaps_label="/data0/wxy/stereo_matching/aanet/res/z_map.npy",
    ...
    def __getitem__(self, idx):
        ...
        sample['keypoints_3d'] = np.pad(shot['keypoints'][:self.num_keypoints],
                                        ...
                                        'constant',
                                        constant_values=1.0)
        sample['occlusion'] = np.zeros((self.num_keypoints))
    ...
    def evaluate(self,
        ...
        keypoints_gt = keypoints_gt[:,:,[0,2,1]]
        keypoints_gt_relative = keypoints_gt - keypoints_gt[:, root_index:
                                                            root_index + 1, :]
        keypoints_3d_predicted_relative = keypoints_3d_predicted - keypoints_3d_predicted[:,
                                                                                          root_index:
