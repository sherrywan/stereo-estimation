...
def rectification_calculation(K1, K2, RT1, RT2, dims1=(1000, 1000), dims2=(1000, 1000)):
    '''calculate the rectification homographies that minimize distortion

    Args:
        K1 (float32): left camera instinsic matrix
        K2 (float32): right camera instinsic matrix
        RT1 (float32): left camera extrinsic matrix
    ...
    Rectify1, Rectify2 = getDirectRectifications(K1, K2, RT1, RT2, dims1, dims2, F)
